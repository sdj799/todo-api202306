...
public class TodoController {
    ...
    //할 일 등록 요청
    @PostMapping
    public ResponseEntity<?> createTodo(@Validated @RequestBody TodoCreateRequestDTO dto
    ...
    public ResponseEntity<?> updateTodo(@Validated @RequestBody TodoModifyRequestDTO dto
